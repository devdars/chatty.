...
class FirebaseMessagingHandler {
  ...
  static AndroidNotificationChannel channel_call = const AndroidNotificationChannel(
    'com.devans.chatty.call', // id-call channel
    'chatty_call', // call channel title
  ...
  static AndroidNotificationChannel channel_message = const AndroidNotificationChannel(
    'com.devans.chatty.message', // message channel id
    'chatty_message', // message channel title
  ...
  static Future<void> config() async {
    ...
    try {
      ...
      var initializationSettingsAndroid = const AndroidInitializationSettings("ic_launcher"); // android initialization settings
      var darwinInitializationSettings =const DarwinInitializationSettings(); //ios initialization settings
