...
class AccessTokenController extends Controller
{
    public function get_rtc_token(Request $request){
        $channelName = $request->input("channel_name"); //from flutter app
        $appID = "af00b2471db8460ba687965700261e2e"; //from agora
        $appCertificate = "d2d4bdd1e28e41dbb2b84ac65144ed40"; //from agora
        $uid = 0; //agora autofills 
        $expireTimeInSeconds = 7200;  //60 mins
